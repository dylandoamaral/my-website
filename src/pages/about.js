...
export default ({ data }) => (
        <Layout>
          <Wrapper>
            ...
            <p>Je suis un étudiant en Big Data qui va très bientôt terminer son cursus, je suis actuellement à Taïwan pour mon dernier semestre et je m'ennuie un peu. Alors j'ai décidé de faire ce site sans prétention aucune, afin de faire passer le temps et de partager ce que j'aime faire. De base, je voulais faire une version de mon CV sur cette page mais en y réfléchissant, pour l'instant cela n'a aucun intérêt puisque <OutboundLink href={CV} download>mon CV</OutboundLink> est là pour ça ainsi que <OutboundLink href="https://www.linkedin.com/in/dylan-do-amaral-431219112/">ma page LinkedIn</OutboundLink>.</p>
