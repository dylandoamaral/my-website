...
class Citation extends React.Component {
    ...
    animate = () => {
        let rightAnimation = (window.innerWidth > parseInt(resolutions.medium)) ? "right" : "rightsmall";
        let leftAnimation = (window.innerWidth > parseInt(resolutions.medium)) ? "left" : "leftsmall";
    ...
    render() {
        return (
            <AnimateText pose={this.state.animation}>{this.state.citation}</AnimateText>
        );
    }
}
